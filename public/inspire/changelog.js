...
const ChangelogApp = {
    CHANGES: [
        { date: '2026-08-11', tag: '新增', type: 'feat', title: '新增 about 页', desc: 'header 右侧新增 about 独立页：正文为工具说明，下方附修订记录；about 页不显示侧边栏与菜单按钮，分类 tab 不高亮' },
        { date: '2026-08-11', tag: '优化', type: 'refactor', title: '顶部导航调整与样式统一', desc: '「成绩录入」更名「自主训练」；右侧入口（自主训练/about）样式统一为分类 tab 风格（普通/悬停/激活三态）；后台侧边栏移除「修订记录」入口' },
